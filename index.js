...
function sortLowToHigh(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortHighToLow(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let result = sortResultsByPrice(sortBy, hotels);
...
app.get('/hotels/sort/rating', (req, res) => {
  let sortByRating = req.query.rating;
  let result = sortResultsByRating(sortByRating, hotels);
  res.json({ hotels: result });
});

// Reviews

function sortReviewLeastToMost(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

function sortReviewMostToLeast(hotel1, hotel2) {
